		...
		<div class="row">
			<div class="col">
				<nav class="navbar navbar-expand-lg navbar-dark">
				  <a class="navbar-brand" href="index.php"> <img src="images/sufiana-white.png" alt=""></a>
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    <ul class="navbar-nav mr-auto">
				      ...
				      <form class="form-inline my-2 my-lg-0">
					      ...
					      <button class="btn btn-outline-success bg-success my-2 my-sm-0 mr-2" type="button"><a class="btn text-white" href="login.php"> Login</a></button>
